...
= 1.5.5 =
* Enhanced error messages for better clarity.
* Fixed undefined property error in PPP.
* Fixed frontend issue in transparent checkout.

= 1.5.4 =
* Added new payment method to transparent checkout.

= 1.5.3 =
* Added support for WooCommerce 9.1 and WordPress 6.6.
* Fixed compatibility issues with PHP 8.1.
* Optimized slow query handling in webhook processing for better performance.

= 1.5.2 =
* Fixed rendering of the checkout.

= 1.5.1 =
* Improved log display.
* Enhanced webhook rendering.
* Fixed issue with transactions processed without transaction ID.

= 1.5.0 =
* Updated dependencies.
* Added support for WooCommerce 8.7 and WordPress 6.4.3.
* Improvement on payments gateways.
* Improved transparent checkout for smoother transactions.
* Fixed PHP warnings.
* Enhanced rendering of webhooks.

<div class="admin-options-container">
    ...
    <?php if ((empty($_POST) && $this->enabled === 'yes') || (isset($_POST) && $this->get_updated_values()['enabled'] === 'yes')): ?>
        ...
        <?php if (get_option($this->get_option_key() . '_validator') === 'no'): ?>
            ...
            <div id="message" class="error inline">
                <p>
                    <strong>
                        <?php _e("It was not possible to activate the \"Save Digital Wallet\" functionality because we verified that your PayPal account does not have permission to use this product. Contact PayPal at 0800 721 6959 and request its release.", "paypal-brasil-para-woocommerce"); ?>
                    </strong>
                </p>
            </div>
        <?php endif; ?>
    ...
    <img class="banner" srcset="<?php echo esc_attr(
        plugins_url(
            'assets/images/banner-plus-2x.png',
            PAYPAL_PAYMENTS_MAIN_FILE
        )); ?> 2x"
        ...
        <tbody>
            ...
            <tr valign="top">
                <th scope="row" class="titledesc">
                    <label for="<?php echo esc_attr($this->get_field_key('title_complement')); ?>">
                        <?php echo esc_html($this->get_form_fields()['title_complement']['title']); ?>
                    </label>
                </th>
                <td class="forminp">
                    <fieldset>
                        ...
                        <p class="description">
                            <?php _e("Will be displayed at checkout: Credit Card ", "paypal-brasil-para-woocommerce"); ?>
                            {{titleComplement ? '(' +
                            titleComplement +
                            ')':
                            ''}}
            ...
            <tr valign="top" :class="{hidden: !isLive()}">
                ...
                <td class="forminp">
                    <fieldset>
                        <legend class="screen-reader-text"><span>
                                <?php _e("Secret", "paypal-brasil-para-woocommerce"); ?>
                            </span></legend>
                        <input class="input-text regular-input" type="text"
            ...
            <tr valign="top">
                <th scope="row" class="titledesc">
                    <label for="<?php echo esc_attr($this->get_field_key('invoice_id_prefix')); ?>">
                        <?php esc_html_e('Prefix in number
                    order', "paypal-brasil-para-woocommerce"); ?>
                    </label>
                </th>
                <td class="forminp">
                    <fieldset>
                    ...
                    order', "paypal-brasil-para-woocommerce"); ?>
                        ...
                        <p class="description">
                            <?php esc_html_e('Add a prefix to the order number, this is useful for identifying you when you have more than one store processing through PayPal.', "paypal-brasil-para-woocommerce"); ?>
                        </p>
                    </fieldset>
                </td>
            </tr>

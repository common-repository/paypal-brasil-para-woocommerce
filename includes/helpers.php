 ...
 * @return array
 */
function paypal_brasil_get_shipping_address_order_v2( $order ) {
	$line1 = array();
	$line2 = array();
	...
	$shipping_address = array(
		'address_line_1'  => $order_data['address_1'],
		'admin_area_1'   => $order_data['city'],
		'admin_area_2'   => $order_data['state'],
		'postal_code'    => $order_data['postcode'],
		'country_code'   => $order_data['country']
	);
